...
1. transform wide format into long, ubah kolom menjadi row
2. select column: country, year, case
3. grouping by country and year
4. total case summary
5. ungrouping
6. join with population column
7. filter show only population <> na
8. calculated the proportional
